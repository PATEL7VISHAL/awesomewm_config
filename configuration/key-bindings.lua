...
local globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "c", function() awful.spawn(apps.editor) end,
        { description = "open a editor", group = "launcher" }),
    awful.key({ modkey, }, "e", function() awful.spawn(apps.files) end,
        { description = "open a filemanger", group = "launcher" }),
    awful.key({ modkey, }, "v", function() awful.spawn(apps.music) end,
        { description = "open a terminal", group = "launcher" }),
    ...
    --? Power Menu
    awful.key({ modkey, "Shift" }, "s", function() awful.spawn('poweroff') end,
        { description = "take a screenshot", group = "menu" }),
